...
export const messages = {
  "zh-CN": {
    ...
    dashboard: {
      ...
      clientPort: "客户端端口",
      accessMode: "访问方式",
      directAccess: "公网 IP + 端口",
      reverseProxyAccess: "反向代理",
      directAccessHelp: "服务端监听配置的 HOST，可通过公网 IP 和映射端口直接访问。",
      reverseProxyAccessHelp: "服务端仅监听 127.0.0.1，请将 Nginx、Caddy 等反向代理转发到该端口。",
      enable: "启用",
      cancel: "取消",
      save: "保存",
      webDefaultName: "Web",
  ...
  en: {
    ...
    dashboard: {
      ...
      reconnectAttempt: "Consecutive Retries",
      ...
      directAccess: "Public IP + Port",
      reverseProxyAccess: "Reverse Proxy",
      directAccessHelp: "The server listens on the configured HOST and accepts direct public IP and mapped-port access.",
      reverseProxyAccessHelp: "The server listens on 127.0.0.1 only. Forward Nginx, Caddy, or another local reverse proxy to this port.",
      enable: "Enable",
      cancel: "Cancel",
      save: "Save",
      webDefaultName: "Web",
