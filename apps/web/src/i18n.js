...
export const messages = {
  "zh-CN": {
    ...
    dashboard: {
      ...
      accessMode: "端口暴露方式",
      directAccess: "对外监听",
      reverseProxyAccess: "仅本机监听",
      directAccessHelp: "监听服务端配置的 HOST，可通过服务器 IP 和映射端口访问。",
      reverseProxyAccessHelp: "仅监听 127.0.0.1，适合通过同机 Nginx、Caddy 等反向代理访问。",
      enable: "启用",
      cancel: "取消",
      save: "保存",
      webDefaultName: "Web",
  ...
  en: {
    ...
    dashboard: {
      ...
      accessMode: "Port Exposure",
      directAccess: "External Listener",
      reverseProxyAccess: "Localhost Only",
      directAccessHelp: "Listens on the configured server HOST and accepts traffic through the server IP and mapped port.",
      reverseProxyAccessHelp: "Listens on 127.0.0.1 only, for access through Nginx, Caddy, or another proxy on the same host.",
      enable: "Enable",
      cancel: "Cancel",
      save: "Save",
      webDefaultName: "Web",
